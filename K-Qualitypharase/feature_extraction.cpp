//include helper.h and aho_carosick.h within the code
#include "utils/helper.h"
#include "aho_corasick.h"
#include <cassert>
//this file is used to extract features and generate a new file name as final.csv
//the input files used in this code is Patterns.csv , stopwordsFromText.txt , stopwords.txt , sentences.buf
...
{
//read stopwordsFromText.txt
    FILE* in = tryOpen("stopwordsFromText.txt", "r");
    for (;getLine(in);) {
...
{
	FILE* in = tryOpen("sentences.buf", "rb");
	size_t size;
	Binary::read(in, size);
...
{
	FILE* in = tryOpen("patterns.csv", "r");
	for (;getLine(in);) {
		vector<string> tokens = splitBy(line, ',');
...
int main(int argc, char* argv[])
{
    ...
    loadSentences("sentences.buf");
    loadPattern("patterns.csv");
    loadStopwords("stopwordsFromText.txt", "stopwords.txt");
